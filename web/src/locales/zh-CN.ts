export default {
  ...
  workflow: {
    ...
    splitModeNarrativeMV: '🎬 叙事MV',
    splitModeNarrativeMVTip: '叙事MV模式：创建三幕式电影短片+音乐。第一部分（序幕 ~75秒）：纯电影画面，无音乐——呈现世界观与角色。第二部分（音乐电影）：故事继续推进，音乐同步播放——画面讲述故事，音乐提供情感氛围。第三部分（尾声 ~60秒）：纯电影画面收尾。输入格式：使用 [STORY_BIBLE]、[CHARACTERS]、[PROLOGUE]、[MUSIC_SEGMENTS]、[LYRICS]、[EPILOGUE] 标记的故事圣经格式。',
    mvGenreProfile: '流派',
    mvGenreGamingHorror: '🎮 游戏恐怖 (FNAF, Poppy Playtime, Sprunki, CG5风格)',
    mvGenreCinematicMovie: '🎬 电影动画 (第三视角动画电影风格)',
  ...
  professionalEditor: {
    ...
    batch: {
      ...
      resetConfirmMsg: '确定要清除这些镜头生成的所有内容（提示词、图片、视频）吗？此操作将把所有镜头恢复为初始状态。',
      resettingData: '正在清理数据，请稍候...',
      resetSuccess: '重置成功，所有数据已变为空白就绪状态！',
      resetFailed: '重置失败',
      imageModel: '图片模型:',
      videoModel: '视频模型:',
      generationMode: '生成模式:',
