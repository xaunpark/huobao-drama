export default {
  ...
  drama: {
    ...
    customStylePlaceholder: 'Enter your custom style description',
  ...
  workflow: {
    ...
    splitModeAuto: 'Auto Detect',
    splitModePreserve: 'Preserve Structure',
    splitModeBreakdown: 'Action Units',
    splitModeVisualUnit: 'Visual Unit (Voice-over)',
    ...
    splitModeNarrativeMV: '🎬 Narrative MV',
    splitModeNarrativeMVTip: 'Narrative MV Mode: Creates a 3-part cinematic short film with music. Part 1 (Prologue ~75s): Pure film, no music — establishes world and characters. Part 2 (Music Film): Story continues while music plays — visuals tell the story, music provides emotion. Part 3 (Epilogue ~60s): Pure film resolution. Input: Story Bible format with [STORY_BIBLE], [CHARACTERS], [PROLOGUE], [MUSIC_SEGMENTS], [LYRICS], [EPILOGUE] sections.',
    mvGenreProfile: 'Genre',
    mvGenreGamingHorror: '🎮 Gaming Horror (FNAF, Poppy Playtime, Sprunki, CG5 style)',
    mvGenreCinematicMovie: '🎬 Cinematic Movie (Animated movie acting, third-person)',
  ...
  tooltip: {
    ...
    sceneNamePlaceholder: 'Enter scene name, e.g., Large mall interior corridor',
    timePlaceholder: 'Enter time, e.g., 2:00 PM',
    sceneDescription: 'Scene Description',
    sceneDescriptionPlaceholder: 'Enter scene description',
    extractSceneDialogTitle: 'Extract Scenes from Script',
    extractSceneDialogTip: 'Will automatically extract scene information from the current episode\'s script content',
    startExtract: 'Start Extracting',
    sceneAddSuccess: 'Scene added successfully',
    sceneAddFailed: 'Failed to add scene',
    pleaseEnterSceneName: 'Please enter a scene name',
    chapterInfoNotExist: 'Chapter information does not exist',
    sceneExtractSubmitted: 'Scene extraction task submitted, please refresh to check results later',
    sceneExtractFailed: 'Failed to extract scenes',
    imageUploadSuccess: 'Image uploaded successfully',
    imageUploadSuccessNoUrl: 'Image uploaded successfully, but couldn\'t get image URL',
    sceneImageUploadSuccess: 'Scene image uploaded successfully!',
    sceneImageGenerateComplete: 'Scene image generation complete!',
    sceneImageGenerateStarted: 'Scene image generation started',
    deleteCharacterConfirm: 'Are you sure you want to delete this character? This cannot be undone.',
  ...
  professionalEditor: {
    ...
    batch: {
      ...
      resetConfirmMsg: 'Are you sure you want to delete all generated data (Image Prompts, Images, Videos) for these shots? This action will reset storyboards to their original state.',
      resettingData: 'Clearing data...',
      resetSuccess: 'Cleared successfully, all shots are now pending!',
  ...
  editor: {
    ...
    noFirstFrameImage: 'No first frame image',
    noKeyFrameImage: 'No key frame image',
    noLastFrameImage: 'No last frame image',
    goToGenerateImage: 'Go to generate image'
  },
  video: {
