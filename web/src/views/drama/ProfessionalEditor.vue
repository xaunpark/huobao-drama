              ...
              <div class="video-generation-section">
                ...
                <div class="video-prompt-container" style="margin-bottom: 20px;">
                  <div class="section-label" style="display: flex; align-items: center; gap: 8px;">
                    ...
                    <el-tag
                      v-if="currentStoryboard?.video_prompt_distilled"
                      type="success"
                      size="small"
                      effect="dark"
                    >✨ AI Distilled</el-tag>
                    <el-tag
                      ...
                      type="danger"
                      size="small"
                    >⏳ Pending Distill</el-tag>
                  </div>
                  <el-input
                    v-model="currentVideoPrompt"
                    type="textarea"
                    :rows="8"
                    placeholder="Video prompt will be generated by AI distillation..."
                    resize="vertical"
                    @blur="() => {
                      if (currentStoryboard) {
                        currentStoryboard.video_prompt_distilled = currentVideoPrompt;
                        saveStoryboardField('video_prompt_distilled');
                      }
                    }"
                  />
...
watch(
  ...
  async () => {
    ...
    // Use AI-distilled video prompt only
    currentVideoPrompt.value =
      currentStoryboard.value.video_prompt_distilled || "";
  },
  { immediate: true },
);
